...
class ACPContentView extends View
{
    public function index()
    {
        ...
        $fields->put(new MysString("page"), null);
        $fields->put(new MysString("title"), null);
        $fields->put(new MysString("page::edit"), new MysString("getEditLink"));
        $fields->put(new MysString("page::delete"), new MysString("getDeleteLink"));
