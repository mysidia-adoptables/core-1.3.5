...
class ACPTradeView extends View
{
    public function index()
    {
        ...
        $fields->put(new MysString("tid"), null);
        $fields->put(new MysString("type"), null);
        $fields->put(new MysString("sender"), null);
        $fields->put(new MysString("recipient"), new MysString("getText"));
        $fields->put(new MysString("message"), null);
        $fields->put(new MysString("status"), null);
        $fields->put(new MysString("tid::edit"), new MysString("getEditLink"));
        $fields->put(new MysString("tid::delete"), new MysString("getDeleteLink"));
    ...
    public function moderate()
    {
        ...
        $fields->put(new MysString("message"), null);
        $fields->put(new MysString("status"), null);
        $fields->put(new MysString("tid::moderate"), new MysString("getModerateLink"));
    ...
    public function settings()
    {
        ...
        $tradeSystem->put(new MysString("Enabled"), new MysString("enabled"));
        $tradeSystem->put(new MysString("Disabled"), new MysString("disabled"));
