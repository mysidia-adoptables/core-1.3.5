...
class AdminSidebar extends Widget implements Initializable
{
    ...
    public function initialize()
    {
        ...
        $level = new Division();
        $level->add(new Link("admincp/alternate/add", "Add Alternate Forms"));
        $level->add(new Link("admincp/alternate/edit", "Edit Alternate Forms"));
        $level->add(new Link("admincp/alternate/delete", "Delete Alternate Forms"));
        $components->add($level);
