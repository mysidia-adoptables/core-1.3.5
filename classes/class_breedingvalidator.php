...
class BreedingValidator extends Validator
{
    ...
    public function __construct(private readonly OwnedAdoptable $female, private readonly OwnedAdoptable $male, private readonly BreedingSetting $settings, private ArrayObject $validations)
    {
    }
