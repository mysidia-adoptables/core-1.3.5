...
class Friend extends UserDecorator
{
    ...
    public function sendrequest()
    {
        ...
        $exist1  = $mysidia->db->select("friend_requests", ["fromuser"], "fromuser='{$mysidia->user->username}' and touser='{$this->username}'")->fetchColumn();
        $exist2 = $mysidia->db->select("friend_requests", ["fromuser"], "touser='{$mysidia->user->username}' and fromuser='{$this->username}'")->fetchColumn();
    ...
    public function append($uid)
    {
        ...
        $mysidia->db->update("users", ["friends" => $friends], "username='{$this->user->username}'");
    }
    ...
    public function setprivacy()
    {
        ...
        $mysidia->db->update("users_options", ["pmstatus" => $mysidia->input->post("pm"), "vmstatus" => $mysidia->input->post("vm"), "tradestatus" => $mysidia->input->post("trade")], "username='{$user->username}'");
    }
}
