...
final class Mysidia extends Core
{
    ...
    */
    ...
    {
        if (!class_exists('GlobalSystem')) {
            throw new ClassNotFoundException('Cannot load class GlobalSystem.');
        }
        $this->systems = new GlobalSystem($this->db);
        Registry::set(new String("systems"), $this->systems, true, true);
        return $this->systems;
    }
