...
class TableBuilder extends Table
{
    ...
    */
     ...
     * @param MysString  $field
     * @param MysString  $method
     * @access public
     * @return Void
     */
    public function setMethod($field, $method)
    {
        ...
        $this->methods->put(new MysString($field), new MysString($method));
    }
    ...
    public function setParams($field, $params)
    {
        ...
        $this->params->put(new MysString($field), $params);
    }
        ...
        if ($fields instanceof LinkedList) {
            while ($iterator->hasNext()) {
                ...
                if ($field instanceof TCell) {
                    $row->add($field);
                } elseif ($field instanceof MysString) {
