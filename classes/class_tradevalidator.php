...
class TradeValidator extends Validator
{
    ...
    public function __construct(private readonly TradeOffer $trade, private readonly TradeSetting $settings, private ArrayList $validations)
    {
    }
    ...
    private function checkInterval()
    {
        ...
        $lastDate = $mysidia->db->select("trade", ["date"], "sender ='{$this->trade->getSender()}' ORDER BY date DESC LIMIT 3")->fetchColumn();
