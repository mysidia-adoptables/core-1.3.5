...
final class AscendingSubMap extends SubMap
{
    ...
    public function descendingMap()
    {
        ...
        return (($map == null) ? new DescendingSubMap($this->map, $this->fromStart, $this->lowInclusive, $this->toEnd, $this->highInclusive, $this->low, $this->high) : $map);
    }
    ...
    public function headMaps(Objective $toKey, $inclusive = false)
    {
        ...
        return new AscendingSubMap($this->map, $this->fromStart, $this->lowInclusive, false, $inclusive, $this->low, $toKey);
    }
    ...
    public function subMaps(Objective $fromKey, $fromInclusive, Objective $toKey, $toInclusive)
    {
        ...
        return new AscendingSubMap($this->map, false, $fromInclusive, false, $toInclusive, $fromKey, $toKey);
    }
    ...
    public function tailMaps(Objective $fromKey, $inclusive)
    {
        ...
        return new AscendingSubMap($this->map, false, $inclusive, $this->toEnd, $this->highInclusive, $fromKey, $this->high);
    }
