...
final class DescendingSubMap extends SubMap
{
     ...
     */
    public const string SERIALID = "912986545866120460L";
    ...
    public function descendingMap()
    {
        ...
        return (($map == null) ? new AscendingSubMap($this->map, $this->fromStart, $this->lowInclusive, $this->toEnd, $this->highInclusive, $this->low, $this->high) : $map);
    }
    ...
    public function headMaps(Objective $toKey, $inclusive = false)
    {
        ...
        return new DescendingSubMap($this->map, false, $inclusive, $this->toEnd, $this->highInclusive, $toKey, $this->high);
    }
    ...
    public function subMaps(Objective $fromKey, $fromInclusive, Objective $toKey, $toInclusive)
    {
        ...
        return new DescendingSubMap($this->map, false, $toInclusive, false, $fromInclusive, $toKey, $fromKey);
    }
    ...
    public function tailMaps(Objective $fromKey, $inclusive)
    {
        ...
        return new DescendingSubMap($this->map, $this->fromStart, $this->lowInclusive, false, $inclusive, $this->low, $fromKey);
    }
