...
class TreeMap extends Map implements NavigableMappable
{
    ...
    */
    ...
    {
        $map = ($this->descendingMap == null) ? new DescendingSubMap($this, true, true, true, true, null, null) : $this->descendingMap;
        return $map;
    }
    ...
    {
        return new AscendingSubMap($this, true, true, false, $inclusive, null, $toKey);
    }
    ...
    {
        return new AscendingSubMap($this, false, $fromInclusive, false, $toInclusive, $fromKey, $toKey);
    }
    ...
    {
        return new AscendingSubMap($this, false, $inclusive, true, true, $fromKey, null);
    }
