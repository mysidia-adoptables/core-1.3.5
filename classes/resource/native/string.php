...
final class MysString extends MysObject implements Iterator, Primitive
{
    ...
    */
     ...
     * @param MysString $string literal string
     * @param MysString $encoding string encoding (default null, auto-detection)
     * @return MysString
     */
     ...
     * @param MysString $substr substring
     ...
     * @param MysString $left  left  delimiter
     * @param MysString $right right delimiter
     * @return MysString
     */
     ...
     * If no match is found, returns null.
     * @param MysString $substr1
     * @param MysString $substr2
     * @return array
     */
     ...
     * @param MysString $charlist characters to remove (default space characters)
     * @return MysString
     */
     ...
     * @param MysString $encoding encoding (default null)
     */
     ...
     * @param MysString $string formatting string
     * @param array $args
     * @return MysString
     */
     ...
     * @param MysString $charset String's charset (default alpha-numeric characters)
     * @return MysString
     */
