...
class CKEditor
{
     ...
     */
    public const timestamp = 'B1GG4Z6';
    ...
    private function init()
    {
        ...
        // Skip relative paths...
        if (!str_starts_with((string) $ckeditorPath, '..')) {
    ...
    private function ckeditorPath()
    {
        ...
        if (isset($_SERVER['SCRIPT_FILENAME'])) {
            $realPath = dirname((string) $_SERVER['SCRIPT_FILENAME']);
        } else {
            /**
         ...
         */
        $selfPath = dirname((string) $_SERVER['PHP_SELF']);
