...
class HTMLPurifier_Config
{
    ...
    public function get($key, $a = null)
    {
        ...
        if (!isset($this->def->info[$key])) {
            ...
            $this->triggerError(
                'Cannot retrieve value of undefined directive ' . htmlspecialchars((string) $key),
                E_USER_WARNING
            );
            return;
        }
    ...
    public function getBatch($namespace)
    {
        ...
        if (!isset($full[$namespace])) {
            $this->triggerError(
                'Cannot retrieve undefined namespace ' . htmlspecialchars((string) $namespace),
                E_USER_WARNING
            );
            return;
        }
    ...
    public function set($key, $value, $a = null)
    {
        ...
        if (!isset($this->def->info[$key])) {
            $this->triggerError(
                'Cannot set undefined directive ' . htmlspecialchars((string) $key) . ' to value',
                E_USER_WARNING
            );
            return;
        }
