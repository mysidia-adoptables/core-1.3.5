...
class HTMLPurifier_Lexer_DirectLex extends HTMLPurifier_Lexer
{
    ...
    public function tokenizeHTML($html, $config, $context)
    {
        ...
        while (++$loops) {
            ...
            if ($maintain_line_numbers) {
                ...
                $nl_pos = strrpos((string) $html, $nl, $rcursor - $length);
            ...
            $position_next_lt = strpos((string) $html, '<', $cursor);
            $position_next_gt = strpos((string) $html, '>', $cursor);
            ...
            if (!$inside_tag && $position_next_lt !== false) {
                ...
                if (
                    ...
                    $position_comment_end = strpos((string) $html, '-->', $cursor);
    ...
    protected function substrCount($haystack, $needle, $offset, $length)
    {
        ...
        if ($oldVersion) {
            ...
            return substr_count($haystack, (string) $needle);
        } else {
    ...
    public function parseAttributeString($string, $config, $context)
    {
        ...
        while (true) {
            ...
            if (!$key) {
                ...
                $cursor += strcspn($string, (string) $this->_whitespace, $cursor + 1); // prevent infinite loop
                continue; // empty key
            }
