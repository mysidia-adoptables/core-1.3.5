        ...
        if ($year_as_text) {
            ...
            if ($year_id !== null || $all_id !== null) {
                $_html_years .= ' id="' . smarty_function_escape_special_chars(
                    $year_id !== null ? ($year_id ?: $_name) : ($all_id ? ($all_id . $_name) : $_name)
                ) . '"';
            }
            if ($year_size) {
    ...
    if ($display_months) {
        ...
        if ($month_id !== null || $all_id !== null) {
            $_html_months .= ' id="' . smarty_function_escape_special_chars(
                $month_id !== null ? ($month_id ?: $_name) : ($all_id ? ($all_id . $_name) : $_name)
            ) . '"';
        }
        if ($month_size) {
    ...
    if ($display_days) {
        ...
        if ($day_id !== null || $all_id !== null) {
            $_html_days .= ' id="' . smarty_function_escape_special_chars(
                $day_id !== null ? ($day_id ?: $_name) : ($all_id ? ($all_id . $_name) : $_name)
            ) . '"';
        }
        if ($day_size) {
