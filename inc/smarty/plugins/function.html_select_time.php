    ...
    if ($display_hours) {
        ...
        if ($hour_id !== null || $all_id !== null) {
            $_html_hours .= ' id="' . smarty_function_escape_special_chars(
                $hour_id !== null ? ($hour_id ?: $_name) : ($all_id ? ($all_id . $_name) : $_name)
            ) . '"';
        }
        if ($hour_size) {
    ...
    if ($display_minutes) {
        ...
        if ($minute_id !== null || $all_id !== null) {
            $_html_minutes .= ' id="' . smarty_function_escape_special_chars(
                $minute_id !== null ? ($minute_id ?: $_name) : ($all_id ? ($all_id . $_name) : $_name)
            ) . '"';
        }
        if ($minute_size) {
    ...
    if ($display_seconds) {
        ...
        if ($second_id !== null || $all_id !== null) {
            $_html_seconds .= ' id="' . smarty_function_escape_special_chars(
                $second_id !== null ? ($second_id ?: $_name) : ($all_id ? ($all_id . $_name) : $_name)
            ) . '"';
        }
        if ($second_size) {
    ...
    if ($display_meridian && !$use_24_hours) {
        ...
        if ($meridian_id !== null || $all_id !== null) {
            $_html_meridian .= ' id="' . smarty_function_escape_special_chars(
                $meridian_id !== null ? ($meridian_id ?: $_name) : ($all_id ? ($all_id . $_name) : $_name)
            ) . '"';
        }
        if ($meridian_size) {
