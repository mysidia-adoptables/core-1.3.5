...
class Smarty_Internal_Compile_Assign extends Smarty_Internal_CompileBase
{
    ...
    public function compile($args, $compiler, $parameter)
    {
        ...
        if ($compiler->tag_nocache || $compiler->nocache) {
            ...
            if (isset($compiler->template->tpl_vars[trim((string) $_attr['var'], "'")])) {
                $compiler->template->tpl_vars[trim((string) $_attr['var'], "'")]->nocache = true;
            } else {
                $compiler->template->tpl_vars[trim((string) $_attr['var'], "'")] = new Smarty_variable(null, true);
            }
        }
        // scope setup
