    ...
    public function compile($args, $compiler, $parameter)
    {
        ...
        */
        ...
        if (($compiler->smarty->merge_compiled_includes || $_attr['inline'] === true) && !$compiler->template->source->recompiled
            ...
            if (!$compiler->has_variable_string && (substr_count((string) $include_file, '"') == 2 or substr_count((string) $include_file, "'") == 2)
               and substr_count((string) $include_file, '(') == 0 and substr_count((string) $include_file, '$_smarty_tpl->') == 0) {
                $tpl_name = null;
                ...
                if (!isset($compiler->smarty->merged_templates_func[$tpl_name]) || $compiler->inheritance) {
                    ...
                    if (!($tpl->source->uncompiled) && $tpl->source->exists) {
                        ...
                        $tpl->properties['file_dependency'][$tpl->source->uid] = [$tpl->source->filepath, $tpl->source->timestamp,$tpl->source->type];
