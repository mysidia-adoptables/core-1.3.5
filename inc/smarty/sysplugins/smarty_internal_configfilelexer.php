...
class Smarty_Internal_Configfilelexer
{
    ...
    public function yy_r2_7($yy_subpatterns)
    {
        ...
        if (!$this->smarty->config_booleanize || !in_array(strtolower((string) $this->value), ["true", "false", "on", "off", "yes", "no"])) {
            $this->yypopstate();
    ...
    public function yy_r6_2($yy_subpatterns)
    {
        ...
        preg_match("/\"\"\"[ \t\r]*[\n#;]/", (string) $this->data, $match, PREG_OFFSET_CAPTURE, $this->counter);
        if (isset($match[0][1])) {
            $to = $match[0][1];
        } else {
