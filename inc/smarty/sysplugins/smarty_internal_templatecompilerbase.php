...
abstract class Smarty_Internal_TemplateCompilerBase
{
    ...
    {
        $this->nocache_hash = str_replace('.', '-', uniqid(random_int(0, mt_getrandmax()), true));
    }
    ...
    public function trigger_template_error($args = null, $line = null)
    {
        ...
        $error_text = 'Syntax Error in template "' . $this->template->source->filepath . '"  on line ' . $line . ' "' . htmlspecialchars(trim((string) preg_replace('![\t\r\n]+!', ' ', $match[$line - 1]))) . '" ';
        if (isset($args)) {
