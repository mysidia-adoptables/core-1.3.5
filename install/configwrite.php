...
$query = "CREATE TABLE {$prefix}adoptables (id int NOT NULL AUTO_INCREMENT PRIMARY KEY, type varchar(40), class varchar(40), description varchar(300), eggimage varchar(120), whenisavail varchar(50), alternates varchar(10), altoutlevel int DEFAULT 0, shop varchar(20), cost int DEFAULT 0)";
$adopts->query($query);
...
$query = "CREATE TABLE {$prefix}levels (lvid int NOT NULL AUTO_INCREMENT PRIMARY KEY, adoptiename varchar(50), thisislevel int DEFAULT 0, requiredclicks int DEFAULT 0, primaryimage varchar(120), rewarduser varchar(10), promocode varchar(25))";
$adopts->query($query);
...
$query = "CREATE TABLE {$prefix}owned_adoptables (aid int NOT NULL AUTO_INCREMENT PRIMARY KEY, type varchar(40), name varchar(40), owner varchar(40), currentlevel int DEFAULT 0, totalclicks int DEFAULT 0, code varchar(15), imageurl varchar(120), alternate varchar(10), tradestatus varchar(15), isfrozen varchar(10), gender varchar(10), offsprings int DEFAULT 0, lastbred int DEFAULT 0)";
$adopts->query($query);
...
<title>Mysidia Adoptables v1.3.5 Installation Wizard</title>
<style type='text/css'>
<!--
body,td,th {
	color: #000000;
...
<center><table width='750' border='0' cellpadding='0' cellspacing='0'>
  ...
  <tr>
    <td width='750' height='57' valign='top' bgcolor='#FF3300'><div align='left'>
      <p><span class='style1'>Mysidia Adoptables v1.3.5 Installation Wizard <br>
