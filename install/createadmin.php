...
$email = $_POST["email"];
$salt = codegen(15, 0);
$username = preg_replace("/[^a-zA-Z0-9\\040.]/", "", (string) $username);
    ...
    <td height='643' valign='top' bgcolor='#FFFFFF'><p align='left'><br>
      ...
      <form name='form1' method='post' action='sitesetting.php'>
        ...
        <p class='style2'>Browser Title: 
          <input name='browsertitle' type='text' id='browsertitle' maxlength='50' value='Mysidia Adoptables v1.3.5'>
        </p>
        ...
        <p><span class='style2'># Rows for Pagination: 
