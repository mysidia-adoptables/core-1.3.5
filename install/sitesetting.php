...
$query = "INSERT INTO {$prefix}settings (name, value) VALUES ('pagination', '{$pagination}')";
$adopts->query($query);
...
<center><table width='750' border='0' cellpadding='0' cellspacing='0'>
  ...
  <tr>
    <td height='643' valign='top' bgcolor='#FFFFFF'><p align='left'>&nbsp;</p>
      ...
      <p align='left'>Mysidia Adoptables v1.3.5 has been installed on your site and is ready for your use! Before you get going, there's a few things you should know: </p>
      <blockquote>
        ...
        <p align='center' class='style4'><a href='../index'>View Your Website</a></p>
      </blockquote></td>
  </tr>
</table>
</center>
