...
class MessagesController extends AppController
{
    ...
    public function index()
    {
        ...
        try {
            ...
            $stmt = $mysidia->db->select("messages", [], "touser='{$mysidia->user->username}' ORDER BY id DESC LIMIT {$pagination->getLimit()},{$pagination->getRowsperPage()}");
    ...
    protected function validate(User $recipient)
    {
        ...
        if (!empty($recipient->friends)) {
            $friends = explode(",", (string) $recipient->friends);
        }
