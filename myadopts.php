...
class MyadoptsController extends AppController
{
    ...
    public function index()
    {
        ...
        $pagination = new Pagination($total, $mysidia->settings->pagination, "myadopts");
        $pagination->setPage($mysidia->input->get("page"));
        $stmt = $mysidia->db->select("owned_adoptables", ["aid"], "owner = '{$mysidia->user->username}' ORDER BY totalclicks LIMIT {$pagination->getLimit()},{$pagination->getRowsperPage()}");
    ...
    public function manage()
    {
        ...
        $this->setField("name", new MysString($this->adopt->getName()));
    ...
    public function rename()
    {
        ...
        if ($mysidia->input->post("submit")) {
            ...
            $poundpet = $mysidia->db->select("pounds", [], "aid='{$this->adopt->getAdoptID()}'")->fetchObject();
