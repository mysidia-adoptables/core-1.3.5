...
class StatsController extends AppController
{
    public function index()
    {
        ...
        $stmt = $mysidia->db->select("owned_adoptables", ["aid"], "1 ORDER BY totalclicks DESC LIMIT 10");
        ...
        $stmt = $mysidia->db->select("owned_adoptables", ["aid"], "1 ORDER BY RAND() DESC LIMIT 5");
