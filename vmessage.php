...
class VmessageController extends AppController
{
    ...
    public function __construct()
    {
        ...
        if ($mysidia->systems->vmessages != "enabled") {
            throw new NoPermissionException("The admin has turned off visitor messages feature for this site, please contact him/her for detailed information.");
        }
    }
    ...
    public function view()
    {
        ...
        $stmt = $mysidia->db->select("visitor_messages", ["vid"], "(touser = '{$mysidia->input->get("id")}' and fromuser = '{$mysidia->input->get("id2")}') or (touser = '{$mysidia->input->get("id2")}' and fromuser = '{$mysidia->input->get("id")}') ORDER BY vid DESC LIMIT 0, 25");
